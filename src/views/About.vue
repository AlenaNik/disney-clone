<template>
  <div class="min-h-screen bg-cover" :style="{ backgroundImage: `url('${background}')` }">
    ...
    <div class="w-96 xl:w-1/3 pl-16 text-white leading-loose">
      Dolor sit amet consectetur adipisicing elit. Natus fugit tenetur velit quasi soluta sunt suscipit, eveniet dolorum. Tenetur architecto voluptatum quis, vitae autem, vero tempora libero impedit culpa debitis, quisquam nam nemo quidem modi sunt illo consequuntur maiores magni.
    </div>
  </div>
</template>
